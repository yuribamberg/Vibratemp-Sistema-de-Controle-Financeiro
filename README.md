...
Copiar o JavaFX: Certifique-se de que a pasta do JavaFX SDK está em C:\javafx.

Copiar o Projeto: Coloque a pasta inteira do projeto no computador da loja.

Executar: Dê dois cliques no arquivo iciar.bat (ou Vibratemp.bat) presente na pasta raiz do projeto.
