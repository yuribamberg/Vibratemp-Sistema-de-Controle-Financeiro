...
Instale o Java: Caso ainda não tenha, baixe e instale o Java (https://java.com/download).

Copie a pasta JavaFX: Coloque a pasta do JavaFX SDK no caminho C:\javafx.

Copie o Projeto: Copie a pasta inteira do projeto para o PC da loja.

Executar: Basta dar dois cliques no arquivo .bat (ex: Iniciar.bat / Vibratemp.bat) presente na pasta do projeto.
